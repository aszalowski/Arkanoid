...
\subsubsection{\texorpdfstring{assertionPassed()}{assertionPassed()}}
...
\subsubsection{\texorpdfstring{benchmarkEnded()}{benchmarkEnded()}}
...
\subsubsection{\texorpdfstring{exceptionEarlyReported()}{exceptionEarlyReported()}}
...
\subsubsection{\texorpdfstring{getCurrentTestName()}{getCurrentTestName()}}
...
\subsubsection{\texorpdfstring{getLastResult()}{getLastResult()}}
...
\subsubsection{\texorpdfstring{handleExpr()}{handleExpr()}}
...
\subsubsection{\texorpdfstring{handleFatalErrorCondition()}{handleFatalErrorCondition()}}
...
\subsubsection{\texorpdfstring{handleIncomplete()}{handleIncomplete()}}
...
\subsubsection{\texorpdfstring{handleNonExpr()}{handleNonExpr()}}
