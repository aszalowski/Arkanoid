...
\subsubsection{\texorpdfstring{ITransientExpression()}{ITransientExpression()}}
...
\subsubsection{\texorpdfstring{$\sim$ITransientExpression()}{~ITransientExpression()}}
...
\subsubsection{\texorpdfstring{isBinaryExpression()}{isBinaryExpression()}}
